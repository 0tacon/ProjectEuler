...
void StringNum::TruncateStringNum(uint64_t n)
{
...
StringNum StringNum::operator^(StringNum other)
{
	StringNum result = *this, unity("1.000000");

	for (StringNum num_prods("1.000000"); !(num_prods == other); num_prods = num_prods + unity)
	{
		result = result * *this;
	}
